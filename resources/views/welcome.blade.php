...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">Sobre
                            mí</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0 text-black w-75">Bienvenidos a nuestro Club. Aquí
                podrás encontrar información sobre Edusaurio y nuestras actividades artísticas y de entretención.</p>
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
        <div class="container">
            ...
            <div class="row">
                <!-- imagen redonda responsiva -->
                <div class="col-lg-4 offset-lg-4 mt-2 mb-4 col-md-6 offset-md-3 ">
                    <img class="img-fluid rounded-circle" src="assets/img/edusaurio.jpeg" alt="..." />
                </div>


                <div class="col-lg-8 offset-lg-2">
                    <p class="lead">
                        Eduardo Contreras, más conocido en el circuito de la comedia como EDUSAURIO . Aparte de ser
                        comediante y animador, es un hombre muy inquieto y en su vida, ha realizado muchas actividades
                        dignas de destacar: Marino, ingeniero mecánico, piloto de avión, emprendedor y le encanta
                        comunicar y entretener.
                    </p>
                </div>
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <p class="lead fw-bold">
                        Conducción: Eduardo Contreras "Edusaurio"
                    </p>
                    <p class="lead fw-bold">
                        Dirección : Jpérezvidela.
                    </p>
                ...
                <div class="video-gallery">
                    <div class="video-wrapper">
                        <a href="#" class="modal-btn"
                            data-video="https://www.youtube.com/embed/PSC4TcLJfAg?si=rjuh98Jokc3zo779">
